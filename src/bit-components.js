...
export const LeftRemote = defineComponent();
export const RightRemote = defineComponent();
export const LeftHand = defineComponent();
export const RightHand = defineComponent();
